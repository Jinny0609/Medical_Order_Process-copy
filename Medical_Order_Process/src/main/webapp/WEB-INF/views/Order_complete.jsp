	...
	<div class="Order_complete_container">
		...
		<div class="info_container">
			...
			<div class="info-wrapper">
				...
				<div class="info-content-wrapper">
					<div class="info-content">
				    	<span class="info-label">주문금액:</span> <span class="info-value"><fmt:formatNumber value="${totalPriceWithoutDelivery}" type="number" pattern="#,###"/>원</span>
					</div>
					<div class="info-content">
						<span class="info-label">배송비:</span> <span class="info-value"><fmt:formatNumber value="2500" type="number" pattern="#,###"/>원</span>
					</div>
					<hr>
					<div class="info-content">
					    <span class="info-label">총 결제금액:</span> <span class="info-value"><fmt:formatNumber value="${totalPrice}" type="number" pattern="#,###"/>원</span>
					</div>
				</div>
			</div>
		</div>
