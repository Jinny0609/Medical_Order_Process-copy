...
<header>
  ...
  <section>
    <div class="I_BOX">
      <h1 class="I_logo">
        <a>
          <img src="resources/img/Product_details/coupang.png" alt="쿠팡로고" width="174" height="39">
        </a>
      </h1>
      <div class="search">
...
<body>
  <div class="B_itembox">
    <div><img class="I_img" src="resources/img/Product_details/Jsagi.jpg" alt="의료용품이미지"></div>
    <div class="I_Detail">
      <div class="I_title"><h4>일회용 주사기(D/Syringe)</h4></div>
      <div class="I_ex">
        <span>판매가 </span><span>5,010원</span>
    </div>
      <div class="I_ex">배송비 <span>2,500원</span> / 주문시결제(선결제)</div>
      <div class="I_ex">자체상품코드  <span>2321421</span></div>
      <div class="S_sun"></div>
      <div>
        <select id="option-select" class="form-select" aria-label="Default select example">
      ...
      <div>
        <div class="I_BT">
        <button type="button" class="btn btn-outline-primary">장바구니 담기</button><button type="button" class="btn btn-primary">바로 구매</button> 
        </div>
    </div>
  </div>
